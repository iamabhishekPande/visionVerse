...
model = YOLO(r'D:\VisionVerse_Detection\TrainYolo\runs\detect\train6\weights\best.pt')
confidence_threshold = 0.60
representations_file = r'D:\VisionVerse_Detection\Database\final_updated.pkl'

with open(representations_file, 'rb') as f:
    preloaded_faces = pickle.load(f)

# Define folders for captured and result images
capture_folder = 'Captured_Picture'
